...
export const adminTemplateFiles = [
  ...
  'src/features/access/access-error.tsx', 'src/features/access/access.test.tsx', 'src/features/access/invitation-acceptance-form.tsx', 'src/features/access/queries.ts', 'src/features/access/roles-page.tsx', 'src/features/access/users-page.tsx',
...
export const requiredTemplateFiles = [
  ...
  'api/internal/auth/domain/user.go', 'api/internal/auth/domain/access.go', 'api/internal/auth/domain/access_test.go', 'api/internal/auth/domain/invitation.go', 'api/internal/auth/domain/invitation_test.go', 'api/internal/auth/domain/uuid.go', 'api/internal/auth/application/errors.go', 'api/internal/auth/application/access.go',
