...
export const adminTemplateFiles = [
  ...
  'src/routes/_authenticated/roles.tsx', 'src/routes/_authenticated/settings.tsx', 'src/routes/_authenticated/users.tsx', 'src/routes/-access.test.ts',
  ...
  'src/features/settings/email-settings-page.tsx', 'src/features/settings/operation-log-retention-card.tsx', 'src/features/settings/settings.test.tsx',
  'src/test/msw.ts', 'src/test/setup.ts',
  'e2e/auth.spec.ts', 'e2e/online-users.spec.ts',
];
...
export const requiredTemplateFiles = [
  ...
  'api/migrations/000003_rbac.up.sql', 'api/migrations/000003_rbac.down.sql', 'api/migrations/000004_system_settings.up.sql', 'api/migrations/000004_system_settings.down.sql', 'api/migrations/000005_operation_logs.up.sql', 'api/migrations/000005_operation_logs.down.sql', 'api/migrations/000006_operation_log_snapshots.up.sql', 'api/migrations/000006_operation_log_snapshots.down.sql', 'api/migrations/migrate-entrypoint.sh',
  ...
  'api/internal/auth/domain/user.go', 'api/internal/auth/domain/access.go', 'api/internal/auth/domain/access_test.go', 'api/internal/auth/domain/invitation.go', 'api/internal/auth/domain/invitation_test.go', 'api/internal/auth/domain/uuid.go', 'api/internal/auth/application/errors.go', 'api/internal/auth/application/access.go', 'api/internal/auth/application/cursor.go', 'api/internal/auth/application/cursor_test.go',
  ...
  'api/internal/auth/application/authentication.go', 'api/internal/auth/application/password_recovery.go',
  ...
  'api/internal/auth/application/mail_dispatcher_test.go', 'api/internal/auth/application/application_test.go',
  ...
  'api/internal/auth/adapter/postgres/store_test.go', 'api/internal/auth/adapter/postgres/store_integration_test.go', 'api/internal/auth/adapter/postgres/settings.go',
  ...
  'api/internal/auth/adapter/redis/scripts.go', 'api/internal/auth/adapter/redis/store.go', 'api/internal/auth/adapter/redis/online.go', 'api/internal/auth/adapter/redis/online_integration_test.go',
  ...
  'api/internal/auth/adapter/httpapi/routes.go', 'api/internal/auth/adapter/httpapi/response.go', 'api/internal/auth/adapter/httpapi/online.go', 'api/internal/auth/adapter/httpapi/online_test.go', 'api/internal/auth/adapter/httpapi/online_integration_test.go',
