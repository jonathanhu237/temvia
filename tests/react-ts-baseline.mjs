...
export const requiredTemplateFiles = [
  ...
  'api/internal/auth/application/ports.go', 'api/internal/auth/application/setup.go', 'api/internal/auth/application/operation_log.go', 'api/internal/auth/application/operation_log_test.go',
  ...
  'api/internal/auth/adapter/postgres/store.go', 'api/internal/auth/adapter/postgres/accounts.go', 'api/internal/auth/adapter/postgres/operation_log.go',
