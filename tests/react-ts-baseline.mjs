...
export const adminTemplateFiles = [
  ...
  'src/routes/__root.tsx', 'src/routes/_authenticated.tsx', 'src/routes/_authenticated/index.tsx', 'src/routes/_authenticated/invitations.tsx',
  ...
  'src/features/settings/email-settings-page.tsx', 'src/features/settings/settings.test.tsx',
...
export const requiredTemplateFiles = [
  ...
  'api/migrations/000003_rbac.up.sql', 'api/migrations/000003_rbac.down.sql', 'api/migrations/000004_system_settings.up.sql', 'api/migrations/000004_system_settings.down.sql', 'api/migrations/migrate-entrypoint.sh',
