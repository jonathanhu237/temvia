...
export const adminTemplateFiles = [
  ...
  'src/features/access/access-error.tsx', 'src/features/access/access.test.tsx', 'src/features/access/data-table.tsx', 'src/features/access/drafts.ts', 'src/features/access/invitation-acceptance-form.tsx', 'src/features/access/queries.ts', 'src/features/access/roles-page.tsx', 'src/features/access/users-page.tsx',
  ...
  'src/routes/_authenticated/roles.tsx', 'src/routes/_authenticated/users.tsx', 'src/routes/-access.test.ts',
...
export const requiredTemplateFiles = [
  ...
  'api/migrations/000003_rbac.up.sql', 'api/migrations/000003_rbac.down.sql', 'api/migrations/migrate-entrypoint.sh',
