...
export const adminTemplateFiles = [
  ...
  'src/app/context.ts', 'src/app/providers.tsx', 'src/app/query-client.test.ts', 'src/app/query-client.ts', 'src/app/router.tsx',
  'src/components/ui/alert-dialog.tsx', 'src/components/ui/alert.tsx', 'src/components/ui/badge.tsx', 'src/components/ui/button.tsx', 'src/components/ui/card.tsx',
  'src/components/ui/checkbox.tsx', 'src/components/ui/dialog.tsx', 'src/components/ui/select.test.tsx',
  'src/components/ui/dropdown-menu.tsx', 'src/components/ui/field.tsx', 'src/components/ui/input.tsx',
  'src/components/ui/label.tsx', 'src/components/ui/select.tsx', 'src/components/ui/separator.tsx', 'src/components/ui/sheet.tsx',
  'src/components/ui/sidebar.tsx', 'src/components/ui/skeleton.tsx', 'src/components/ui/sonner.tsx',
  'src/components/ui/table.tsx', 'src/components/ui/tooltip.tsx',
  'src/features/auth/auth-page.test.tsx', 'src/features/auth/auth-page.tsx', 'src/features/auth/authenticated-shell.tsx',
  'src/features/identity/system-identity.tsx',
  'src/features/auth/form-fields.tsx', 'src/features/auth/forms.test.tsx',
  'src/features/auth/login-form.tsx', 'src/features/auth/password-reset-request-form.tsx', 'src/features/auth/password-reset-form.tsx',
  'src/features/auth/queries.test.ts', 'src/features/auth/queries.ts', 'src/features/auth/schemas.test.ts',
  'src/features/auth/schemas.ts', 'src/features/auth/session-error.tsx', 'src/features/auth/setup-form.tsx',
  'src/features/operation-log/operation-logs-page.test.tsx', 'src/features/operation-log/operation-logs-page.tsx',
  'src/features/email-tasks/email-tasks-page.test.tsx', 'src/features/email-tasks/email-tasks-page.tsx',
  ...
  'src/features/auth/session-monitor.tsx', 'src/features/auth/session-monitor.test.tsx', 'src/features/auth/user-avatar.tsx',
  ...
  'src/routes/__root.tsx', 'src/routes/_authenticated.tsx', 'src/routes/_authenticated/index.tsx', 'src/routes/_authenticated/invitations.tsx', 'src/routes/_authenticated/operation-logs.tsx', 'src/routes/_authenticated/email-tasks.tsx',
  'src/routes/forgot-password.tsx', 'src/routes/login.tsx', 'src/routes/reset-password.tsx', 'src/routes/setup.tsx', 'src/routes/accept-invitation.tsx',
  'src/routes/_authenticated/roles.tsx', 'src/routes/_authenticated/settings.tsx', 'src/routes/_authenticated/users.tsx', 'src/routes/_authenticated/personal-settings.tsx', 'src/routes/-access.test.ts',
  ...
  'src/shared/bootstrap/setup-authority.test.ts', 'src/shared/bootstrap/setup-authority.ts', 'src/shared/feedback.test.tsx', 'src/shared/feedback.ts',
  ...
  'src/features/settings/email-settings-page.tsx', 'src/features/settings/operation-log-retention-card.tsx', 'src/features/settings/personal-account-settings-page.test.tsx', 'src/features/settings/personal-account-settings-page.tsx', 'src/features/settings/settings-navigation.tsx', 'src/features/settings/settings-section.tsx', 'src/features/settings/settings.test.tsx', 'src/features/settings/system-identity-page.test.tsx', 'src/features/settings/system-identity-page.tsx',
  'src/test/msw.ts', 'src/test/setup.ts',
  'e2e/auth.spec.ts', 'e2e/first-run.spec.ts', 'e2e/online-users.spec.ts', 'e2e/personal-account-settings.spec.ts', 'e2e/email-tasks.spec.ts', 'e2e/system-identity.spec.ts', 'e2e/user-lifecycle.spec.ts',
];
...
export const requiredTemplateFiles = [
  ...
  'api/internal/auth/domain/user.go', 'api/internal/auth/domain/access.go', 'api/internal/auth/domain/access_test.go', 'api/internal/auth/domain/invitation.go', 'api/internal/auth/domain/invitation_test.go', 'api/internal/auth/domain/uuid.go', 'api/internal/auth/application/errors.go', 'api/internal/auth/application/access.go', 'api/internal/auth/application/identity.go', 'api/internal/auth/application/identity_test.go', 'api/internal/auth/application/cursor.go', 'api/internal/auth/application/cursor_test.go',
  'api/internal/auth/application/ports.go', 'api/internal/auth/application/setup.go', 'api/internal/auth/application/operation_log.go', 'api/internal/auth/application/operation_log_test.go', 'api/internal/auth/application/online.go', 'api/internal/auth/application/online_test.go',
  'api/internal/auth/application/authentication.go', 'api/internal/auth/application/password_recovery.go', 'api/internal/auth/application/personal_settings.go', 'api/internal/auth/application/personal_settings_test.go',
  'api/internal/auth/application/password_recovery_test.go', 'api/internal/auth/application/mail_dispatcher.go', 'api/internal/auth/application/settings.go', 'api/internal/auth/application/settings_test.go',
  'api/internal/auth/application/mail_dispatcher_test.go', 'api/internal/auth/application/application_test.go', 'api/internal/auth/application/abuse_protection_test.go', 'api/internal/auth/application/mail_tasks.go', 'api/internal/auth/application/mail_tasks_test.go',
  'api/internal/auth/adapter/password/argon2id.go', 'api/internal/auth/adapter/password/argon2id_test.go',
  'api/internal/auth/adapter/postgres/store.go', 'api/internal/auth/adapter/postgres/accounts.go', 'api/internal/auth/adapter/postgres/operation_log.go', 'api/internal/auth/adapter/postgres/online.go', 'api/internal/auth/adapter/postgres/online_integration_test.go',
  ...
  'api/internal/auth/adapter/postgres/recovery.go', 'api/internal/auth/adapter/postgres/access.go', 'api/internal/auth/adapter/postgres/outbox.go', 'api/internal/auth/adapter/postgres/personal_settings.go', 'api/internal/auth/adapter/postgres/mail_tasks.go', 'api/internal/auth/adapter/postgres/mail_tasks_integration_test.go', 'api/internal/auth/adapter/postgres/personal_settings_integration_test.go', 'api/internal/auth/adapter/postgres/sessions.go', 'api/internal/auth/adapter/postgres/limiter.go', 'api/internal/auth/adapter/postgres/cleanup.go', 'api/internal/auth/adapter/postgres/state_integration_test.go',
  ...
  'api/migrations/000010_user_lifecycle.up.sql', 'api/migrations/000010_user_lifecycle.down.sql', 'api/migrations/000011_personal_account_settings.up.sql', 'api/migrations/000011_personal_account_settings.down.sql', 'api/migrations/000012_email_tasks.up.sql', 'api/migrations/000012_email_tasks.down.sql',
  ...
  'api/internal/auth/adapter/httpapi/httpapi_test.go', 'api/internal/auth/adapter/httpapi/access_http_test.go', 'api/internal/auth/adapter/httpapi/settings_http_test.go', 'api/internal/auth/adapter/httpapi/mail_tasks.go', 'api/internal/auth/adapter/httpapi/mail_tasks_test.go', 'api/internal/auth/adapter/httpapi/mail_tasks_integration_test.go', 'api/internal/auth/adapter/httpapi/personal_settings.go', 'api/internal/auth/adapter/httpapi/personal_settings_test.go', 'api/internal/auth/adapter/httpapi/personal_settings_integration_test.go',
...
export async function assertAdminBaseline(directory, { materialized = true } = {}) {
  ...
  const dependencyVersions = {
    '@hookform/resolvers': '5.9.1', '@radix-ui/react-alert-dialog': '1.1.23', '@radix-ui/react-checkbox': '1.3.11', '@radix-ui/react-dialog': '1.1.23',
    ...
    '@tanstack/react-router': '1.170.32', '@tanstack/react-table': '8.21.3', 'class-variance-authority': '0.7.1',
    ...
    tailwindcss: '4.3.3', 'tw-animate-css': '1.4.0', zod: '4.5.4', zustand: '5.0.8',
  };
