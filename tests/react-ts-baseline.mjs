...
export const requiredTemplateFiles = [
  ...
  'api/internal/auth/adapter/postgres/store_test.go', 'api/internal/auth/adapter/postgres/store_integration_test.go', 'api/internal/auth/adapter/postgres/limiter_test.go', 'api/internal/auth/adapter/postgres/settings.go', 'api/internal/auth/adapter/postgres/identity.go',
