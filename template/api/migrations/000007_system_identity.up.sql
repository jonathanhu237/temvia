CREATE TABLE auth_system_identity (
    ...
    english_system_name text NOT NULL DEFAULT '',
    ...
    CONSTRAINT auth_system_identity_english_name_length CHECK (char_length(english_system_name) <= 50),
...
INSERT INTO auth_system_identity (singleton, system_name, english_system_name, icon_media_type, icon_bytes, revision)
